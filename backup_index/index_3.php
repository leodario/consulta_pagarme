...
<script>
    ...
    <body class="body_bg" style="margin: 0 auto; width:100%">
                    ...
                    <div id="rd-column-joq3m2mp" class="bricks--column rd-column">
                        <div>
                            ...
                            <div id="rd-text-joq3m2mr" class="bricks--component bricks--component-text rd-text">
                                <p>Você realiza o pagamento no cartão, ou à vista no boleto, e
        ...
        <div class="row">    
                ...
                <div class="bg-agende">
                    ...
                    <br><br> 
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3>Preencha os seus dados e entraremos em contato para agendar sua consulta</h3>
                            </div>
                            ...
                            <div class="separador col-md-12 col-12"></div>

                            <div class="col-md-12 col-12">
                                <label>CPF</label>                            
                                <input type="text" name="senderCPF" id="cpf" placeholder="CPF sem traço" value="" class="form-control" required>                       
                            </div>
                        ...
                        <br>  
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3 col-12">
                                    ...
                                    <input type="text" name="shippingAddressStreet" class="form-control" id="shippingAddressStreet" placeholder="Av. Rua" value="" required>
                                </div>
                                ...
                                <div class="col-md-12 mb-3 col-12">
                                    <label>Número</label>
                                    <input type="text" name="shippingAddressNumber" class="form-control" id="shippingAddressNumber" placeholder="Número" value="" required>
                                </div>
                            ...
                            <div class="col-md-12 col-12">
                                ...
                                <input type="text" name="shippingAddressComplement" class="form-control" id="shippingAddressComplement" placeholder="Complemento" value="">
                            </div>
                            ...
                            <div class="separador col-md-12"></div>
                                ...
                                <div class="col-md-12 mb-3 col-12">
                                    <label>Bairro</label>
                                    <input type="text" name="shippingAddressDistrict" class="form-control" id="shippingAddressDistrict" placeholder="Bairro" value="" required>
                                </div>
                                ...
                                <div class="col-md-12 mb-3 col-12">
                                    <label>Cidade</label>
                                    <input type="text" name="shippingAddressCity" class="form-control" id="shippingAddressCity" placeholder="Cidade" value="" required>
                                </div>
                            ...
                            <div class="col-md-12 col-12">
                                <label>CEP</label>
                                <input type="text" name="shippingAddressPostalCode" class="form-control" id="shippingAddressPostalCode" placeholder="CEP sem traço" value="" required>
                            </div>
...
Entraremos em contato para agendar sua consulta
                            </small>
                        </div>
                        ...
                        <div class="row creditCard">
                            <div class="col-md-6 mb-3 creditCard col-12">
                            ...
                            <div class="col-md-12 mb-3 creditCard col-12">
                        ...
                        <?php
                            ...
                            $total_venda = number_format(1.00, 2, '.', '');
                        ...
                        <span id="aguarde">Pedido processando! Você receberá por e-mail as informações do pagamento.</span>

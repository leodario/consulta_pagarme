...
$DadosArray['paymentMode'] = 'gateway';
...
$total_venda = number_format($valorConsulta, 2, '.', ''); 
*/
$DadosArray['idClinica'] = $Dados['idClinica'];
$DadosArray['itemId1'] = '1';
$DadosArray['itemDescription1'] = 'Decidi Emagrecer - Consulta Internacional';
$DadosArray['itemAmount1'] = $Dados['amount'];

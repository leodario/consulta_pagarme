                ...
                success: function (retorna) {
                    $.ajax({
                        ...
                        data: {
                            ...
                            "senderAreaCodeInter": $('#senderAreaCodeInter').val(),
                            "termoAceite": true
                        },
                        dataType: 'json',
                        success: function (retorna) {
                            console.log(retorna);
                           window.setTimeout("location.href='https://www.5sestilodevida.com.br/'",6000)
                        },
                    ...
                    $("#msg").html('<p style="color: green">Transação realizada! Você receberá por status do pagamento.</p>');
                    //window.location.href = retorna['dados']['paymentLink'];
                    $("#aguarde").css('display','none');
                    
                    
                    alert("Transação realizada! Você receberá por e-mail o status do pagamento.");                  
...
function apagaParcela(){
    $('.parcela2, .parcela3, .parcela4, .parcela5, .parcela6, .parcela7, .parcela8, .parcela9, .parcela10, .parcela11, .parcela12, .parcela13, .parcela14, .parcela15').css('display','none');
}
